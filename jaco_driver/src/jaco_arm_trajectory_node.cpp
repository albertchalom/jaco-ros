#include <jaco_driver/jaco_arm_trajectory_node.h>
...
namespace jaco_arm{
  ...
  void JacoArmTrajectoryController::build_trajectory_spline(const control_msgs::FollowJointTrajectoryGoalConstPtr &goal){
